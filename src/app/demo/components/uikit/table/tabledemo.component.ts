...
export class TableDemoComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.projectService.getProjectsWithOrdersSmall().then(data => this.products = data);
    ...
    expandAll() {
        if (!this.isExpanded) {
            this.products.forEach(product => product && product.intitule ? this.expandedRows[product.intitule] = true : '');
